...
x1_train, x1_test, x2_train, x2_test = train_test_split(
    x1, x2, shuffle=True, train_size=0.8)

from sklearn.model_selection import train_test_split
y1_train, y1_test = train_test_split(
    y1, shuffle=True, train_size=0.8)
...
dense1_1 = Dense(15, activation = 'relu')(input1)  # 첫번째 모델의 첫번째 히든레이어 구성
dense1_2 = Dense(33, activation = 'relu')(dense1_1)  # 첫번째 모델의 두번째 히든레이어 구성
dense1_3 = Dense(32, activation = 'relu')(dense1_2)
dense1_4 = Dense(22, activation = 'relu')(dense1_2)
dense1_5 = Dense(13)(dense1_4)



#모델2
input2 = Input(shape = (3, ))
dense2_1 = Dense(19, activation = 'relu')(input2)
dense2_2 = Dense(32, activation = 'relu')(dense2_1)
dense2_3 = Dense(42, activation = 'relu')(dense2_2)
dense2_4 = Dense(20, activation = 'relu')(dense2_2)
dense2_5 = Dense(12)(dense2_4)


from keras.layers.merge import concatenate #단순병합
merge1 = concatenate([dense1_5, dense2_5]) #2개 이상은list [] 사용...

middle1 = Dense(15)(merge1)
middle2 = Dense(22)(middle1)
middle3 = Dense(42)(middle2)
middle4 = Dense(26)(middle3)
middle5 = Dense(14)(middle4)

#아웃풋 구성해야한다. 이제.
#3개짜리 모델2개이다. 아웃풋도 2개이므로, 이것을 만들어줘야한다. 
#output 모델구성

output1 = Dense(14)(middle5)
output2 = Dense(21)(output1)
output3 = Dense(42)(output2)
output4 = Dense(22)(output3)
output5 = Dense(3)(output4) #3으로 나간다. 
 

model = Model(inputs = [input1, input2], outputs=output5) #함수형 모델 명시(input1부터시작해서 output1까지 함수형 모델임을 명시) #list로 구성. 
