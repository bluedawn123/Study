...
y3_train, y3_test = train_test_split(
    y3, shuffle=False, train_size=0.8)   #☆☆☆왜?!?!?!??☆☆☆
...
#모델2
input2 = Input(shape=(2, )) #함수형 모델은 순차모델과 다르게 함수 명시를해줘야한다. #함수형 모델은 기본적으로 input shape 로 한다. , 레이어는 이름을 지정해줘야하므로 input1으로 지정
...
middle1 = Dense(10)(merge1)  #노드 30개 생성
...
output1_1 = Dense(25)(middle3)
output1_2 = Dense(4)(output1_1)
output1_3 = Dense(2)(output1_2) #2으로 나간다. 

output2_1 = Dense(10)(middle3)
output2_2 = Dense(7)(output2_1)
output2_3 = Dense(2)(output2_2) #2으로 나간다. 

output3_1 = Dense(30)(middle3)
output3_2 = Dense(8)(output3_1)
output3_3 = Dense(2)(output3_2) #2로 나간다. 2열이므로. 

#여기서부터 모르겠음.================================================================================================================================================================


model = Model(inputs = [input1, input2], outputs= [output1_3, output2_3, output3_3]) #함수형 모델 명시(input1부터시작해서 output1까지 함수형 모델임을 명시) #list로 구성. 
                                                                                     #왜 나가는게 3개임!?!?!?!?
model.summary() #함수형모델
