...
x1, y1 = split_xy(np_samsung_sp, 3, 1)
x2, y2 = split_xy(np_hite_sp, 3, 1)
print(x1[0, :], "\n", y1[0])
print(x1.shape)
print(y1.shape)
print(x2.shape)
...
x2_train, x2_test, y2_train, y2_test = train_test_split(
    x2, y2, test_size = 0.2)
print("=" * 40)
print(x1_train.shape)                   # (404, 3, 1)
print(x1_test.shape)                    # (102, 3, 1)
print(y1_train.shape)                   # (404, 1)
print(y1_test.shape)                    # (102, 1)
print("=" * 40)
print(x2_train.shape)                   # (404, 3, 5)
print(x2_test.shape)                    # (102, 3, 5)
...
model.fit([x1_train_sc, x2_train_sc], y1_train, callbacks = [es, cp],
          epochs = 10, batch_size = 1, verbose = 1)



### 4. 모델 평가
res = model.evaluate([x1_test_sc, x2_test_sc], y1_test)
print("=" * 20)
print("loss : ", res[0])
print("mse : ", res[1])
