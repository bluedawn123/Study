...
input1_1 = LSTM(100)(input1)         # LSTM 사용
...
input2_1 = LSTM(100)(input2)         # LSTM 사용 
input2_1 = Dense(90)(input2_1)        
input2_1 = Dense(80)(input2_1)         
input2_2 = Dense(20)(input2_1)         
...
model.fit([x1, x2], y, epochs =500, batch_size = 64 #,callbacks = [es] 
          )                
