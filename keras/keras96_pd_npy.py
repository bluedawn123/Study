...
x = iris.data
y = iris.target
print("x의 형태 : ", x.shape)      # (150, 4) #들어가는 게 4!!
print("y의 형태 : ", y.shape)      # (150, )
'''


aaa = np.load('./data/iris_save.npy')  #value값만 불러옴



print("가치값인 aaa의 형태 : ", aaa)

x = aaa[:, 0:4] #[:]모든행 ,  [0:4] 0~3까지의 인데스 
y = aaa[:, -1]   # 4 인덱스 데이터를 가져온다.
