...
x_train_data_load = np.load('./data/mnist_train_x.npy')
y_train_data_load = np.load('./data/mnist_train_y.npy')
x_test_data_load = np.load('./data/mnist_test_x.npy')
y_test_data_load = np.load('./data/mnist_test_y.npy')





print("x_train_data의 타입 ", type(x_train_data_load))
print("y_train_data의 타입 ", type(y_test_data_load))

print("x_train_data_load.shape의 모양 : ", x_train_data_load.shape)  
print("x_test_data_load.shape의 모양 : ", x_test_data_load.shape)  
print("y_train_data_load.shape의 모양 : ", y_train_data_load.shape)  
print("y_test_data_load.shape의 모양 : ", y_test_data_load.shape) 



print("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ넘파이 전처리 전 잘되나 확인ㅡㅡㅡㅡㅡㅡㅡㅡ")
...
model = load_model('./model/check-02 - 0.1085.hdf5')
