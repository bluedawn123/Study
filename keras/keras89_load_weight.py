...
#model.save('./model/model_test01.h5')  #이러면 모델까지만 저장.
...
#model.save('./model/model_test01.h5')  #가중치까지 저장이 된다.

#model.save_weights('.model/test_weight1.h5')   



model.load_weights('.model/test_weight1.h5')   #가중치만 저장 + 웨이트로드를 쓰려면 저장한 layers의 갯수와 실행하는 파일의 layers의 갯수가 같아야 한다. 
