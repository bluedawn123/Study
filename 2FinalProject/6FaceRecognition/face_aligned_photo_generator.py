...
dataset_paths = ['./2FinalProject/data/tedy-front/', './2FinalProject/data/son-front/',
                 './2FinalProject/data/unknown-front/']
output_paths = ['./2FinalProject/data/tedy-align/', './2FinalProject/data/son-align/',
 './2FinalProject/data/unknown-align/']
number_images = 20
image_type = '.jpg'
