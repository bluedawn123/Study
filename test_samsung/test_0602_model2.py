...
print('x_sam:',x_sam)                  # 2020-06-02의 값이 y값으로 들어갔다.
...
#2. 모델 구성
input1 = Input(shape = (5, 1))    #lstm이므로 x_sam의 형태 :  (504, 5, 1)에서 (5, 1)
x1 = LSTM(70)(input1)
x1 = Dropout(0.1)(x1)
x1 = Dense(110)(x1)
x1 = Dropout(0.1)(x1)
...
input2 = Input(shape = (5,  ))       #  densen이므로 x_hite가 (504, 5) 이므로.. (5, )대입
x2 = Dense(50)(input2)
x2 = Dropout(0.1)(x2)
x2 = Dense(70)(x2)
x2 = Dropout(0.1)(x2)
