...
for thresh in thresholds:
    ...
    selection_model = LGBMRegressor(n_estimators=1000, max_depth=4, learning_rate=0.6, n_jobs=-1) 

    selection_model.fit(selection_x_train, y_train, verbose=False, eval_metric=["rmse", "mae"],   #회귀이므로
...
# 모델 저장
pickle.dump(selection_model, open("./model/LGBM_save/boston_85.69%.dat", "wb"))