...
print("x_predict의 형태 ", x_predict.shape)


# reshape( , , )

x = x.reshape(x.shape[0], x.shape[1], 1)                #x = x.reshape(90, 4, 1)

print("x.reshape의 형태 :", x.shape)

x_predict = x_predict.reshape(6, 4, 1)                     #(6, 4, 1)


print("x_predict의 리쉐이프 형태 : ", x_predict.shape)
...
print("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ모델링 끝ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ")
#==================================================================================================
#2. 모델

model = Sequential()
model.add(LSTM(100, input_shape= (4, 1)))                # input_length : time_step (열)
model.add(Dense(100))   
model.add(Dense(100))   
model.add(Dense(80))   
model.add(Dense(50))   
